...
interface ClientStore {
  ...
  addSite: (clientId: string, data: { name: string; address?: string; latitude?: number | null; longitude?: number | null; geoRadius?: number; hourlyRate?: number | null; contractualHours?: number; notes?: string }) => Promise<ClientSite>;
