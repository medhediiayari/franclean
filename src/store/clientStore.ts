...
interface ClientStore {
  ...
  updateClient: (id: string, data: Partial<{ name: string; email: string | null; phone: string | null; address: string | null; notes: string | null; siret: string | null; siren: string | null; formeJuridique: string | null; tvaNumber: string | null; representantLegal: string | null; representantRole: string | null; codeApe: string | null; capitalSocial: string | null; rcs: string | null; canSeeCheckinPhotos: boolean | null; canSeeWorkPhotos: boolean | null }>) => Promise<void>;
  deleteClient: (id: string) => Promise<void>;
  addSite: (clientId: string, data: { name: string; address?: string; latitude?: number | null; longitude?: number | null; geoRadius?: number; hourlyRate?: number | null; contractualHours?: number | null; notes?: string }) => Promise<ClientSite>;
  updateSite: (clientId: string, siteId: string, data: Partial<{ name: string; address: string; latitude: number | null; longitude: number | null; geoRadius: number; hourlyRate: number | null; contractualHours: number | null; notes: string | null }>) => Promise<void>;
